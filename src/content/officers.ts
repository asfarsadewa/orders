...
export const OFFICERS: Record<Department, OfficerSpec> = {
  security: {
    ...
    name: "Captain Ilya",
    short: "ilya",
    traits: "Fast. Aggressive. Acts on what you meant.",
  ...
  medical: {
    ...
    name: "Dr Vale",
    short: "vale",
    traits: "Human life first. Hears ambiguity as permission to save someone.",
  ...
  engineering: {
    ...
    name: "Chief Orlov",
    short: "orlov",
    traits: "Systems thinker. Keeps the machines alive so the colony can be.",
