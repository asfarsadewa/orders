  ...
  return (
    <>
      <div className="status">
        ...
        <Stat k="morale" v={pct(w.morale)} s={w.lowMoraleDays ? `${w.lowMoraleDays} days below the line` : "holding"} level={w.morale} fill={w.morale} />
      ...
      <div className="crises">
        {w.crises.length === 0 && <span className="none">No active crisis. That will not last.</span>}
        {w.crises.map((c) => {
