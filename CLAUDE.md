...
- UI, help and README copy use the ASD-STE100 register: one instruction per sentence, 20 words or fewer, active voice, imperative for instructions, present tense, "if" for conditions. State the mechanic, not the mood. No aphorisms, no rule-of-three for rhythm, no sentence-final punchlines, no semicolon antitheses. Officer dialogue in src/content/lines is character voice and is exempt.
